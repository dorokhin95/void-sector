...
canvas.addEventListener('pointermove',e=>{if(e.pointerType!=='mouse'){mx=e.clientX;my=e.clientY}});
canvas.addEventListener('pointerdown',e=>{if(e.pointerType==='mouse')return;mx=e.clientX;my=e.clientY;firing=true;canvas.setPointerCapture(e.pointerId)});
addEventListener('pointerup',e=>{if(e.pointerType!=='mouse')firing=false});addEventListener('pointercancel',()=>{firing=false;rocketHeld=false});$('fire').onpointerdown=e=>{e.preventDefault();firing=true};
