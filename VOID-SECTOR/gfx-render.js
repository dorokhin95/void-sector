...
function enemyDynamic(e,c,d){
 ...
 if(e.elite){for(const s of [-1,1])draw(models.fin,s*.9,.3,1,.4,.6,.5,[.2,.6,.6],0,0,0,-s*.9,1,{rough:.4,metal:.85});draw(cube,0,.55,.4,.02,.25,.6,[.45,1,.88],1.5,0,0,0,1,{shadow:false})}
